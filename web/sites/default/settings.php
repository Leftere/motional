...
/**
 * Load local settings file for Genuine-hosted temporary environment.
 */
$settings_file = '/srv/files/genuine.settings.php';
if (file_exists($settings_file)) {
  require $settings_file;
}

/**
 * Key for submitting sitemaps automatically.
 */
$settings['simple_sitemap_engines.index_now.key'] = '9de2b5b2-4113-48d1-b193-a6eac8a3e9ba';

/**
 * Redis configuration for Pantheon environments.
 */
